    ...
    <PageTransition>
      <div className="relative min-h-screen pt-20 pb-12">
        ...
        <div className="max-w-7xl mx-auto px-4">
                ...
                <div className="relative z-10">
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between">
                      ...
                      <span className="text-white font-semibold">{profile.stats.solved}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-300">Ranking</span>
                      <span className="text-white font-semibold">{profile.stats.ranking}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-300">Current Streak</span>
                      <span className="text-white font-semibold">{profile.stats.streak}</span>
                    </div>
                  </div>
          ...
          >
            <h2 className="text-3xl font-bold text-white text-center mb-8">Overall Statistics</h2>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
              ...
              <div>
                ...
                <div className="text-gray-300">Contests</div>
              </div>
              <div>
